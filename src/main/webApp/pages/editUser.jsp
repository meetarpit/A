                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="adminlogout"><i class="fas fa-power-off mr-2"></i>Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
...
<c:url value="/updateUser" var="action"></c:url>
<form:form action="${action}" method="post" modelAttribute="user">
<tr>
<td><form:input type="hidden" path="userId"/><form:input type="text" path="fname" style="border:none;" /></td>
<td><form:input type="text" path="lname" style="border:none;" /></td>
<td><form:radiobutton path="gender" label="male" value="M"/><form:radiobutton path="gender" label="female" value="F"/></td>
<td><form:input type="text" path="email" style="border:none;" /></td>
<td><form:input type="text" path="password" style="border:none;" /></td>
<td><form:input type="text" path="phone" style="border:none;" /></td>
<td><form:input type="text" path="address" style="border:none;" /></td>
