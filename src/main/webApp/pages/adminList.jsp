<!--  display all offers at admin side -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Offers List</h2>
...
<td><a href="<c:url value='/editAdmin/${admin.aid}'/>" style="color:green;">Edit</a></td>
<td><a href="<c:url value='/delete/${admin.aid}'/>" style="color:red;">Delete</a></td>
</tr>
</c:forEach>
